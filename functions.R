...
#function for 1,000, 10,000, and 100,000 iterations. If it doesn’t work for 
#one of these values, modify the code so that it does work, and comment the 
#code to describe your solution.
